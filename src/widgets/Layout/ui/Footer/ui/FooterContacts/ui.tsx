import type {TFooterContacts} from "./types.ts";
import type {FC} from "react"
import {Link} from "react-router";
import classNames from "classnames";
import "./FooterContacts.pcss"

const FooterContacts: FC<TFooterContacts> = (props) => {
  const {
    className,
  } = props

  return (
    <address className={classNames(className, "footer-contacts")}>
      <ul className="footer-contacts__list">
        <li className="footer-contacts__item">
          <Link
            ...
            to={`/`}
          >
            <span className="footer-contacts__icon" title="to instagram">
        ...
        <li className="footer-contacts__item">
          <Link
            ...
            to={`/`}
          >
                    <span className="footer-contacts__icon" title="to linkedin">
        ...
        <li className="footer-contacts__item">
          <Link
            ...
            to={`/`}
          >
                    <span className="footer-contacts__icon" title="to facebook">
        ...
        <li className="footer-contacts__item">
          <Link
            ...
            to={`/`}
          >
                    <span className="footer-contacts__icon" title="to twitter">
